        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    // Replacing textWrappingMode with correct properties
                    textMeshPro.overflowMode = TextOverflowModes.Overflow; // Control overflow behavior
                    textMeshPro.enableWordWrapping = true; // Enable word wrapping
                ...
                {
                    // TextMesh Implementation (commented out)
